...
Remove-Module SecretManagement.HashTableBug -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SecretManagement.HashTableBug\SecretManagement.HashTableBug.psd1"
Import-Module "$PSScriptRoot\..\SecretManagement.HashTableBug\SecretManagement.HashTableBug.psm1" -Force
