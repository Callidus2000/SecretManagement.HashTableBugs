...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\SecretManagement.HashTableBug\functions", "$global:testroot\..\SecretManagement.HashTableBug\internal\functions"),
	
	[string]
	$ModuleName = "SecretManagement.HashTableBug",
...
$CommandPath = @(
    "$global:testroot\..\SecretManagement.HashTableBug\functions"
    "$global:testroot\..\SecretManagement.HashTableBug\internal\functions"
)
